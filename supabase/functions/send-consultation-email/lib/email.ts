          ...
          <tr>
            <td style="padding:40px 32px 16px;">
              ...
              <div style="background:linear-gradient(135deg,rgba(34,211,238,0.08),rgba(59,130,246,0.08));border:1px solid rgba(34,211,238,0.2);border-radius:16px;padding:32px;margin-top:16px;">
                ...
                <a href="https://helpmebusiness.com" style="display:block;text-align:center;background:linear-gradient(135deg,#22d3ee,#3b82f6);color:#000;font-weight:800;font-size:15px;padding:16px 32px;border-radius:12px;text-decoration:none;letter-spacing:0.5px;">
...
Schedule Your Consultation → https://helpmebusiness.com
---
